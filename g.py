...
TOKEN = '7300607882:AAGe1Q-a1NJlTHhtgL0Da5YgqzWDl2PGDZc'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002236886540
CHANNEL_ID = -1002236886540
error_channel_id = -1002236886540
...
def approve_or_disapprove_user(message):
    ...
    if not is_admin:
        bot.send_message(chat_id, "*You are not authorized to use this command BSDK 🤬*", parse_mode='Markdown')
        return
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        if user_data:
            ...
            response = "*No account information found. Please contact the administrator @beast_boi69.*"
        bot.reply_to(message, response, parse_mode='Markdown')
    elif message.text == "Help❓":
        bot.reply_to(message, "*Help selected @MANTAL_BGMI*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin selected @beast_boi69*", parse_mode='Markdown')
    else:
